 ...
 */
void spiralMove(xMateErProRobot &robot) {
  error_code ec;
  std::string id;
  ...
  rokae::MoveAbsJCommand absjcmd({0.0, 0.22150561307150393, 0.0, 1.4779577696969546,0.0, 1.2675963456219013, 0.0});
...
int main() {
  try {
    ...
    std::error_code ec;
    xMateErProRobot robot(ip); // ****   xMate 6-axis
    ...
    cartesianPointWithOffset(robot);
    // spiralMove(robot);
